package sg.edu.rp.c346.nationaldayparadethemesongcompilation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DBHelper dbh = new DBHelper(third.this);
                ...
                dbh.updateSong(data);
                Toast.makeText(third.this, "Update successful",
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(third.this, "Delete successful",
                        Toast.LENGTH_SHORT).show();
                finish();
            }
        });
